...
function portalbox_OnLoad(self)
	self:RegisterEvent("VARIABLES_LOADED");
	self:RegisterEvent("UNIT_SPELLCAST_START");
	out("• PortalBox 1.1 Loaded •");
...
function portalbox_OnEvent(self,event,...)
...
function PortalBox_MinimapButton_OnClick(self,button)
...
function portalbox_toggle(num)
	...
	local frame = _G["PortalboxMainFrame"]
	local hordeFrame = _G["PortalboxHordeFrame"]
